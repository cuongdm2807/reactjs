        ...
        <>
            <div className="flex w-full px-24 h-auto my-10" id="cart">
                <div className="w-2/3 h-auto flex-col ">
                            ...
                            {arr_product_cart.map((product, index) => {
                                return (
                                    <tr key={index}>
                                        ...
                                        <td className="border border-gray-300 text-center">
                                            <button className=" focus:outline-none" onClick={()=>handleDeleteCart(product.id)} ><i className="fas fa-trash text-2xl"></i></button>
                                        </td>
                                    </tr>
                                )
                            })}
                    ...
                    <Link to="/product" className="px-6 py-3 uppercase bg-green-700 border-none text-white w-1/4 mt-5">CONTINUE SHOPPING</Link>
                </div>
