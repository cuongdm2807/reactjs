...
const HomePage = () => {
    return (
        <div>
            ...
            <Item />
            <div className="pb-10">
            <iframe class="ext-center py-3 px-32" width="1730" height="550" src="https://www.youtube.com/embed/oQrdiSi3YAg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
